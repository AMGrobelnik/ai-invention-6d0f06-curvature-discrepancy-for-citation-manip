...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `2_gen_plan/` — 3 task(s)
      ...
      - `prompts/2_test_idea/round_1/2_gen_plan/gen_plan_research_2.md` — 3 prompt(s)
    - `3_gen_art/` — 3 task(s)
  ...
  - round_2
    ...
    - `2_gen_plan/` — 2 task(s)
      - `prompts/2_test_idea/round_2/2_gen_plan/gen_plan_experiment_1.md` — 5 prompt(s)
      - `prompts/2_test_idea/round_2/2_gen_plan/gen_plan_research_1.md` — 7 prompt(s)
    - `3_gen_art/` — 2 task(s)
...
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 4 task(s)
    - `prompts/3_report_results/1_gen_viz/gen_viz_1.md` — 6 prompt(s)
    - `prompts/3_report_results/1_gen_viz/gen_viz_2.md` — 4 prompt(s)
    - `prompts/3_report_results/1_gen_viz/gen_viz_3.md` — 5 prompt(s)
    - `prompts/3_report_results/1_gen_viz/gen_viz_4.md` — 5 prompt(s)
